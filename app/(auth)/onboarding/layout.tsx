...
export default function OnboardingLayout({
    ...
    return (
        <div className="flex min-h-svh flex-col bg-background">
            {/* Top Progress Header */}
            <header className="sticky top-0 z-50 border-b border-border bg-card px-6 py-4 shadow-sm">
                <div className="mx-auto max-w-4xl">
                    <div className="flex items-center justify-between">
                        <div className="text-xl font-bold text-foreground">SOP-Guard Pro</div>
                    ...
                    <div className="mt-8 relative">
                        <div className="absolute top-1/2 left-0 w-full h-0.5 -translate-y-1/2 bg-border" />
                        <div
                            ...
                            {STEPS.map((step, idx) => {
                                ...
                                return (
                                    <li key={step.id} className="flex flex-col items-center group">
                                        <div className={cn(
                                            "flex h-8 w-8 items-center justify-center rounded-full border-2 bg-card transition-colors z-10",
                                            isCompleted ? "border-brand-teal bg-brand-teal text-white" : "",
                                            isCurrent ? "border-brand-blue text-brand-blue ring-4 ring-brand-blue/20" : "",
